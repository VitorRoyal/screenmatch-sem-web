...
public class SerieController {
    ...
    @GetMapping("/{id}") //Numero aleatorio definido pelo usuarios na chamada da URL
    public SerieDTO obterPorId(@PathVariable Long id){ //Variavel vinda do path/endpoint
